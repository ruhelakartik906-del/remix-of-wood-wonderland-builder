...
const ArrowBullet = ({ children }: { children: React.ReactNode }) => (
  <li className="flex items-start gap-2 mb-2">
    <ArrowRight size={18} className="shrink-0 mt-1 text-foreground" />
    <span>{children}</span>
  </li>
);
...
const PrivacyPolicy = () => {
  return (
    <Layout>
      ...
      <div className="relative w-full h-[340px] md:h-[420px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-6 md:p-12">
          <div className="flex justify-between items-start">
            <h1 className="text-3xl md:text-4xl text-white tracking-wide leading-tight font-medium whitespace-nowrap">
              PRIVACY POLICY
            </h1>
            <img
              src={infinityLogo}
      ...
      {/* Section 2: Content Body - Clean White Background */}
