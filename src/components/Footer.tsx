...
const iconLinkClass = "w-9 h-9 md:w-10 md:h-10 rounded-full border border-border text-foreground flex items-center justify-center hover:bg-primary hover:text-primary-foreground hover:border-primary hover:scale-110 transition-all";
...
const Footer = () =>
  <footer className="bg-white border-t border-border">
    <div className="container mx-auto px-4 py-6 md:py-16">
      ...
      {/* Main Grid: 3-col centered on mobile, 4-col on lg */}
      <div className="grid grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-5 md:gap-10 mt-4 md:mt-8">
        {/* Quick Links */}
        ...
        <div className="text-center">
          ...
          <ul className="space-y-2 text-xs md:text-sm text-muted-foreground inline-block text-left">
        ...
        {/* Follow Us - full width on mobile, 4th col on lg */}
        <div className="col-span-3 lg:col-span-1 text-center">
          ...
          <div className="flex justify-center lg:justify-start gap-3 flex-wrap">
            <a href="https://www.instagram.com/infinityboards_/" target="_blank" rel="noopener noreferrer" className={iconLinkClass}>
              <Instagram size={16} />
            </a>
            <a href="https://www.facebook.com/profile.php?id=61575329042498" target="_blank" rel="noopener noreferrer" className={iconLinkClass}>
              <Facebook size={16} />
            </a>
            <a href="https://www.linkedin.com/company/infinity-boards/" target="_blank" rel="noopener noreferrer" className={iconLinkClass}>
              <Linkedin size={16} />
            </a>
            <a href="https://www.youtube.com/@InfinityBoards_SRB" target="_blank" rel="noopener noreferrer" className={iconLinkClass}>
              <Youtube size={16} />
            </a>
            <a href="https://x.com/infinityboards_?s=21" target="_blank" rel="noopener noreferrer" className={iconLinkClass}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://pin.it/5RJsGnohq" target="_blank" rel="noopener noreferrer" className={iconLinkClass}>
